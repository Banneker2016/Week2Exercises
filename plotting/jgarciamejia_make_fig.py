...
amo_x = [a for (name,a,e,t) in Asteroids if t == 'AMO']
amo_y = [e for (name,a,e,t) in Asteroids if t == 'AMO']

apo_x = [a for (name,a,e,t) in Asteroids if t == 'APO']
apo_y = [e for (name,a,e,t) in Asteroids if t == 'APO']

ate_x = [a for (name,a,e,t) in Asteroids if t == 'ATE']
ate_y = [e for (name,a,e,t) in Asteroids if t == 'ATE']
...
## which is the border of the plot and make it thicker
