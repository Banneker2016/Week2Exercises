...
# If in the same directory as Lauren_asteroids.py, then use modules:
# import Lauren_asteroids # Import functions and data defined in Lauren_asteroids.py
# Asteroids = Lauren_asteroids.Asteroids # Bring in data array from Lauren_asteroids.py

# Else, do it explicitly:
