...
#print(len(Asteroids))
name=[Asteroids[item][0] for item in xrange(len(Asteroids))\
      if abs(Asteroids[item][1]-1) < 0.2 and Asteroids[item][2] < 0.5]
print(name)
...
a = [Asteroids[row][1] for row in range(len(Asteroids)-1)]

e = [Asteroids[row][2] for row in range(len(Asteroids)-1)]